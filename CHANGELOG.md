...
* Support config files named `behat.dist.y[a]ml` by @uuf6429 in [#1464](https://github.com/Behat/Behat/pull/1477)
...
* CI and Psalm improvements by @stof in [#1430](https://github.com/Behat/Behat/pull/1430)
